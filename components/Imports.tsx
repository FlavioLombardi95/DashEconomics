...
const importsData = {
  ...
  'Giappone': [
    { name: 'Energia', value: 26.3, color: '#3B82F6' },
    { name: 'Materie Prime', value: 20.1, color: '#10B981' },
    { name: 'Elettronica', value: 16.8, color: '#F59E0B' },
    { name: 'Automotive', value: 13.5, color: '#EF4444' },
    { name: 'Farmaceutica', value: 9.2, color: '#8B5CF6' },
    { name: 'Agricoltura', value: 6.7, color: '#06B6D4' },
    { name: 'Tecnologia', value: 4.3, color: '#84CC16' },
    { name: 'Tessile', value: 2.1, color: '#F97316' },
    { name: 'Servizi', value: 1.0, color: '#EC4899' },
    { name: 'Altri', value: 0.0, color: '#6B7280' },
  ],
  'India': [
    { name: 'Petrolio', value: 29.8, color: '#3B82F6' },
    { name: 'Oro', value: 18.4, color: '#10B981' },
    { name: 'Elettronica', value: 15.6, color: '#F59E0B' },
    { name: 'Macchinari', value: 12.9, color: '#EF4444' },
    { name: 'Farmaceutica', value: 9.1, color: '#8B5CF6' },
    { name: 'Automotive', value: 6.8, color: '#06B6D4' },
    { name: 'Agricoltura', value: 4.2, color: '#84CC16' },
    { name: 'Tecnologia', value: 2.3, color: '#F97316' },
    { name: 'Servizi', value: 0.9, color: '#EC4899' },
    { name: 'Altri', value: 0.0, color: '#6B7280' },
  ],
  'Regno Unito': [
    { name: 'Elettronica', value: 24.7, color: '#3B82F6' },
    { name: 'Automotive', value: 19.2, color: '#10B981' },
    { name: 'Farmaceutica', value: 15.8, color: '#F59E0B' },
    { name: 'Tecnologia', value: 12.4, color: '#EF4444' },
    { name: 'Agricoltura', value: 9.6, color: '#8B5CF6' },
    { name: 'Tessile', value: 7.3, color: '#06B6D4' },
    { name: 'Chimica', value: 5.1, color: '#84CC16' },
    { name: 'Servizi', value: 3.2, color: '#F97316' },
    { name: 'Lusso', value: 1.7, color: '#EC4899' },
    { name: 'Altri', value: 0.0, color: '#6B7280' },
  ],
  'Francia': [
    { name: 'Energia', value: 25.6, color: '#3B82F6' },
    ...
    { name: 'Tecnologia', value: 7.8, color: '#06B6D4' },
    { name: 'Tessile', value: 5.2, color: '#84CC16' },
    { name: 'Chimica', value: 3.1, color: '#F97316' },
    { name: 'Servizi', value: 1.3, color: '#EC4899' },
    { name: 'Altri', value: 0.0, color: '#6B7280' },
  ],
  'Italia': [
    { name: 'Energia', value: 26.9, color: '#3B82F6' },
    { name: 'Automotive', value: 19.4, color: '#10B981' },
    { name: 'Elettronica', value: 15.7, color: '#F59E0B' },
    { name: 'Farmaceutica', value: 12.3, color: '#EF4444' },
    { name: 'Agricoltura', value: 9.8, color: '#8B5CF6' },
    { name: 'Tecnologia', value: 7.2, color: '#06B6D4' },
    { name: 'Tessile', value: 4.6, color: '#84CC16' },
    { name: 'Chimica', value: 2.8, color: '#F97316' },
    { name: 'Servizi', value: 1.3, color: '#EC4899' },
    { name: 'Altri', value: 0.0, color: '#6B7280' },
  ],
  'Canada': [
    { name: 'Automotive', value: 28.3, color: '#3B82F6' },
    { name: 'Elettronica', value: 20.1, color: '#10B981' },
    { name: 'Farmaceutica', value: 15.6, color: '#F59E0B' },
    { name: 'Tecnologia', value: 12.8, color: '#EF4444' },
    { name: 'Agricoltura', value: 9.4, color: '#8B5CF6' },
    { name: 'Tessile', value: 6.7, color: '#06B6D4' },
    { name: 'Chimica', value: 4.2, color: '#84CC16' },
    { name: 'Servizi', value: 2.1, color: '#F97316' },
    { name: 'Manifatturiero', value: 0.8, color: '#EC4899' },
    { name: 'Altri', value: 0.0, color: '#6B7280' },
  ],
  'Brasile': [
    { name: 'Elettronica', value: 27.4, color: '#3B82F6' },
    { name: 'Automotive', value: 19.8, color: '#10B981' },
    { name: 'Farmaceutica', value: 15.2, color: '#F59E0B' },
    { name: 'Tecnologia', value: 12.6, color: '#EF4444' },
    { name: 'Macchinari', value: 9.9, color: '#8B5CF6' },
    { name: 'Tessile', value: 7.1, color: '#06B6D4' },
    { name: 'Chimica', value: 4.8, color: '#84CC16' },
    { name: 'Agricoltura', value: 2.3, color: '#F97316' },
    { name: 'Servizi', value: 0.9, color: '#EC4899' },
    { name: 'Altri', value: 0.0, color: '#6B7280' },
  ],
}
